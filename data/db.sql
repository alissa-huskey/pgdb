...
SAVEPOINT end_schema;

-- =========================================================
-- import data
-- =========================================================

COPY actor (actor_id, first_name, last_name, last_update) FROM '__PATH__/3057.dat';

COPY address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '__PATH__/3065.dat';

COPY category (category_id, name, last_update) FROM '__PATH__/3059.dat';

COPY city (city_id, city, country_id, last_update) FROM '__PATH__/3067.dat';

COPY country (country_id, country, last_update) FROM '__PATH__/3069.dat';

COPY customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '__PATH__/3055.dat';

COPY film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '__PATH__/3061.dat';

COPY film_actor (actor_id, film_id, last_update) FROM '__PATH__/3062.dat';

COPY film_category (film_id, category_id, last_update) FROM '__PATH__/3063.dat';

COPY inventory (inventory_id, film_id, store_id, last_update) FROM '__PATH__/3071.dat';

COPY language (language_id, name, last_update) FROM '__PATH__/3073.dat';

COPY payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '__PATH__/3075.dat';

COPY rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '__PATH__/3077.dat';

COPY staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '__PATH__/3079.dat';

COPY store (store_id, manager_staff_id, address_id, last_update) FROM '__PATH__/3081.dat';
